...
#READ PART
#Σε αυτό το κομμάτι διαβάζονται τα csv αρχεία για τη δεξιά τσέπη και ενώνονται σε μια λίστα

print('please wait...')

csv_files = glob.glob('D:/Desktop/Postgrad/Χαρίσης/Εργασία Μηχανική Μάθηση/ProFiles2/*.csv')
list1 = []
...
for i in range(0,10):
    ...
    for j in range(0,1241):
        ...
        ltime.append(l)
    with open(f"D:/Desktop/Postgrad/Χαρίσης/Εργασία Μηχανική Μάθηση/Fakelos2/finalcsv{i}(1).csv",'w') as f:
        write = csv.writer(f)
...
print('data loading for right pocket complete!')
...
csv_files11 = glob.glob('D:/Desktop/Postgrad/Χαρίσης/Εργασία Μηχανική Μάθηση/Fakelos2/*.csv')
...
print('Start')
print()
print('style of data for right pocket')
print()
print(Finals2.head())
print()
...
for i in range(10):
    y[i*1241:i*1241+170] = [0] #walking = 0
    y[i*1241+170:i*1241+350] = [1] #standing = 1
    y[i*1241+350:i*1241+530] = [2] #jogging = 2
    y[i*1241+530:i*1241+710] = [3] #sitting = 3
    y[i*1241+710:i*1241+890] = [4] #biking = 4
    y[i*1241+890:i*1241+1070] = [5] #upstairs = 5
    y[i*1241+1070:i*1241+1241] = [6] #downstairs = 6
...
print('len(X_test)=',len(X_test),' right pocket data')
